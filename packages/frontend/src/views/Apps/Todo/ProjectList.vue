    ...
    <template v-slot:body>
      <div class="iq-todo-page">
        ...
        <div class="add-new-project mt-3 mb-3">
          <b-link href="#" class="d-block new-project" v-b-modal.add_project size="lg"
            ><i class="ri-add-line mr-2" />Add Project</b-link
          >
          <b-modal id="add_project" centered title="Add Project">
            ...
            <template v-slot:modal-footer>
              <b-button variant="none" class="iq-bg-primary" @click="$bvModal.hide('add_project')"
                >Cancel</b-button
              >
            ...
            >
              ...
              >
                <b-link :href="category.href"
                  ><i class="ri-checkbox-blank-circle-fill" :class="'text-' + category.color" />
