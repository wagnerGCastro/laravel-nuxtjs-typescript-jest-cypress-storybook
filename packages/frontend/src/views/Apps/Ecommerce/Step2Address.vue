    ...
    <div class="col-lg-4">
      <div class="iq-card">
        <div class="iq-card-body">
          ...
          <hr>
          <button id="deliver-address" href="javascript:void(0);" @click="submit" type="button" class="btn btn-primary btn-block d-block mt-1 next">Deliver To this Address</button>
        </div>
      </div>
    </div>
  </div>
