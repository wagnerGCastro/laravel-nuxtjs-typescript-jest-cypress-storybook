            ...
            <div class="iq-email-list">
              ...
              <tab-nav :pills="true" vertical id="myTab" class="iq-email-ui" @change="updateTab">
                ...
                <tab-nav-items
                  ...
                  :ariaSelected="true"
                >
                  <template v-slot:title> <i class="ri-star-line" />Starred </template>
                </tab-nav-items>
                <tab-nav-items
                  li-class="nav-link p-0"
                  :active="false"
                  ...
                  :ariaSelected="true"
                >
                  <template v-slot:title> <i class="ri-time-line" />Snoozed </template>
                </tab-nav-items>
                <tab-nav-items
                  li-class="nav-link p-0"
                  :active="false"
                  ...
                  :ariaSelected="true"
                >
                  <template v-slot:title> <i class="ri-file-list-2-line" />Draft </template>
                </tab-nav-items>
                <tab-nav-items
                  li-class="nav-link p-0"
                  :active="false"
                  ...
                  :ariaSelected="true"
                >
                  <template v-slot:title> <i class="ri-mail-send-line" />Sent Mail </template>
                </tab-nav-items>
                <tab-nav-items
                  li-class="nav-link p-0"
                  :active="false"
                  ...
                  :ariaSelected="true"
                >
                  <template v-slot:title> <i class="ri-delete-bin-line" />Trash </template>
                </tab-nav-items>
                <tab-nav-items
                  li-class="nav-link p-0"
                  :active="false"
                  ...
                  :ariaSelected="true"
                >
                  <template v-slot:title> <i class="ri-bookmark-line" />Important </template>
                </tab-nav-items>
                <tab-nav-items
                  li-class="nav-link p-0"
                  :active="false"
                  ...
                  :ariaSelected="true"
                >
                  <template v-slot:title> <i class="ri-spam-line" />Spam </template>
                </tab-nav-items>
              </tab-nav>
